...
// console.log(xTicksNo);

// let xTicks = [];
// let xCount = minX - minX%10;
...
console.log(colorMapper(4));
// console.log(data.monthlyVariance[0].variance)
// console.log(colorMapper(2));

let color = d3.scaleOrdinal(colorList);
color.domain(colorDomain);
// console.log(color(2));

//linear scale color graph for color legend.
...
svg
  ...
  .call(colorAxis);
//     .append("path")
// .attr("d", `M0,6V0H550V6`).attr('stroke','black').attr('transform','translate(40,0)');

// svg.append('g').call(colorLegend).attr('x',200).attr('y',200).attr('transform','translate(14,200)');
...
svg
  .append("g")
  .attr("transform", "translate(0," + (h + margin.top + barHeight / 2) + ")")
  .attr("id", "x-axis")
  .call(xAxis)
  .append("path")
  .attr("d", `M60,0H70`)
...
svg
  ...
  .on("mouseover", (event, d) => {
    // svg.select('#'+d.year +'-'+d.month).attr('stroke','black').attr('stroke-width',1);
    overlay
